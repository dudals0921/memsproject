...
<body>
  ...
  <main id="main">
    ...
    <form:form action="/userAccount/login" modelAttribute="userAccountLoginDto" method="POST">
    	...
    	<div class="row">
           <div class="col-md-4">
               <form:radiobutton path="userAccountType" value="1"/>
               <label for="userAccountType" style="font-weight:300px;">개인</label>
           </div>
           <div class="col-md-4">
               <form:radiobutton path="userAccountType" value="2"/>
               <label for="userAccountType" style="font-weight:300px;">학원</label>
           </div>
      		</div>
		<div>

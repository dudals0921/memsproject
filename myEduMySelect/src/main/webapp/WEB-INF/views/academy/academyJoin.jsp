  ...
  <main id="main">
    ...
    <form:form action="/academyInsert" modelAttribute="academySignUpDto" method="post" name="join" id="join">
     ...
     <spring:hasBindErrors name="academySignUpDto">
      ...
      <br />
      <div class="input_group">
        <label for="academy_passwd2">비밀번호 확인</label>
      ...
      <div class="input_group">
        ...
        <div class="input_group">
          <label for="academy_gu_address">행정구역명</label>
          ...
          <label for="academy_road_address">도로명주소</label>
          ...
          <label for="academy_dong_address">상세주소</label>
     ...
     <div class="input_group">
       ...
       <div class="row">
           <div class="col-md-4">
               <input type="checkbox" id="basic" name="academyKeyword1" value="기초부터">
               <label for="basic" style="font-weight:300px;">기초부터</label>
           </div>
           <div class="col-md-4">
               <input type="checkbox" id="intermediate" name="academyKeyword1" value="중급반">
               <label for="intermediate" style="font-weight:300px;">중급반</label>
           </div>
           <div class="col-md-4">
               <input type="checkbox" id="advanced" name="academyKeyword1" value="심화과정">
               <label for="advanced" style="font-weight:300px;">심화과정</label>
           </div>
       </div>
       <div class="row">
           <div class="col-md-4">
               <input type="checkbox" id="attribute" name="academyKeyword1" value="속성강의">
               <label for="attribute" style="font-weight:300px;">속성강의</label>
           </div>
           <div class="col-md-4">
               <input type="checkbox" id="thorough" name="academyKeyword1" value="꼼꼼한 관리">
